    ...
    def initialize()
      ...
      begin
        ...
        @responsibility_ids = {
          ...
          mw1: self.class.find_or_create_responsibility(name: 'Pan 1', version: 15, role_id: base_role_ids[:onhill]),
          mw2: self.class.find_or_create_responsibility(name: 'Pan 2', version: 15, role_id: base_role_ids[:onhill]),
          mw3: self.class.find_or_create_responsibility(name: 'Shuksan 1', version: 15, role_id: base_role_ids[:onhill]),
          mw4: self.class.find_or_create_responsibility(name: 'Shuksan 2', version: 15, role_id: base_role_ids[:onhill]),
